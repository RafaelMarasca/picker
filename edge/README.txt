...
# Edge Impulse library for picker_agora_vai

This is a C++ library that lets you run the impulse for "picker_agora_vai" (http://localhost:4800/studio/233116) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
